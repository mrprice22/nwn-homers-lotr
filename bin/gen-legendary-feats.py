...
FEATS: list[Feat] = [
    Feat("LEGENDARY_STRENGTH", "Legendary Strength",
         ...
         "+6 bonus to Strength.",
         "ife_X2GrStr1", effect="+6 STR (skin item property)",
    ...
    Feat("LEGENDARY_CHARISMA", "Legendary Charisma",
         ...
         "ife_X2GrCha1", effect="+6 CHA (skin item property)",
         category="Ability Scores"),
]
