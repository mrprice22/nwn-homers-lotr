...
//:: The +1 attack bonus is registered with the per-creature bonus ledger
//:: instead of being linked as an effect: same-type attack-bonus effects do not
//:: stack, so this +1 was invisible to anyone holding Legendary Prowess. The
//:: save bonus and the temporary hit points are stock, and the save bonus is
//:: what the ledger uses as its witness that Aid is still running.
...
// End of Spell Cast Hook
    ...
    BPool_SpellAttack(oTarget, BPOOL_SRC_AID, nAttack, TurnsToSeconds(nDuration));
}
