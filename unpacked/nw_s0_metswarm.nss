//:: Imported verbatim from base game data so that it recompiles against this
//:: module's x0_i0_spells.nss and picks up spellsIsAssociateFriendlyFire()
//:: (roadmap henchmen-prevent-friendly-fire). Do not diverge from stock otherwise.
//::///////////////////////////////////////////////
//:: Meteor Swarm
//:: NW_S0_MetSwarm
