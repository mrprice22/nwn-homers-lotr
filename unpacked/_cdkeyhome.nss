...
// Hobbiton, Angmar, Dunharrow, Lord of the Dark Arts, Basilisk Lair, Kallrist
// Crypt Forge) and an Exit, which is pure travel time on a realm whose
// progress is thrown away. The Admin_CanHomeless fallback below is what still
// gates it on live - see sp_testkit_inc.nss for why the flag check is not
// folded into that helper.
