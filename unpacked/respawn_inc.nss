...
//::
//:: Round 4 added a second caller, pet_respawn.nss, which respawned a petrified
//:: player outright. Round 5 removed it on the admin's call: the petrification
//:: timeout now gives the player a death panel whose Respawn button works
//:: (pet_timeout.nss resurrects before it kills, so the panel is a fresh one)
//:: and they click it themselves, arriving here down the ordinary path. The
//:: extraction stays - one respawn implementation is right either way.
//::
//:: Based on:
